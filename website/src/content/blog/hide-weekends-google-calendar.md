...
tags: ["google calendar", "week view", "how to", "productivity", "calendar view"]
---
...
3. Under **View options**, uncheck **Show weekends**.
4. Go back to your calendar. Weekends are gone.
...
4. In the **View options** section (visible immediately -- no need to scroll far), find the checkbox labeled **Show weekends**.
5. Uncheck it.
...
3. Under **View options**, find **Set custom view**.
4. Click the dropdown. Options range from **2 days** to **4 weeks**.
5. Select **5 days**.
6. Go back to your calendar.
7. In the top-right view switcher, click the dropdown next to the current view name and select your custom view (it appears as "5 days" or whichever range you chose).
...
If you are optimizing your calendar views, [color-coding your events](/blog/color-code-google-calendar-events) adds a second layer of clarity. A clean 5-day view with consistent colors eliminates most visual noise.
...
3. Under **View options**, find **Start week on**.
4. Choose **Saturday**, **Sunday**, or **Monday**.
...
For teams spanning multiple time zones and work-week conventions, [sharing calendars across team members](/blog/share-google-calendar-with-someone) is often more effective than trying to force one view to work for everyone.
...
- Use [color-coding](/blog/color-code-google-calendar-events) to mark your days off.
...
If you use [week numbers in Google Calendar](/blog/show-week-numbers-google-calendar), hiding weekends does not change the week number assignments. Week 12 is still Week 12 whether or not you see Saturday and Sunday. This is correct behavior, but it can look odd when your five-column view shows a week number that seems to start on Monday rather than Sunday (if your locale defines weeks as starting on Sunday).
...
These shortcuts, combined with a weekend-free view, make it possible to scan your entire work week in a few seconds. Once your calendar view is clean, make your workflow even faster with a [Chrome extension for quick calendar access](/blog/google-calendar-extension-for-chrome-quick-view) right from your toolbar.

---

## Sources

- [Google Calendar Help -- Change your calendar view](https://support.google.com/calendar/answer/7638168) -- official documentation for view options, including the "Show weekends" toggle and custom view settings.
- [Google Calendar Help -- Keyboard shortcuts](https://support.google.com/calendar/answer/37034) -- full list of keyboard shortcuts, including the X shortcut for custom views.
- [Google Calendar Help Community](https://support.google.com/calendar/community) -- user-reported threads on mobile limitations, non-standard work weeks, and weekend toggle behavior.
