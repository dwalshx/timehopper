...
If you work across time zones regularly, consider [setting a secondary time zone in Google Calendar](/blog/how-to-change-time-zone-in-google-calendar) so you never need to do the math manually.
...
|---|---|---|
| 00:00 | 7:00 PM (prev day) | 4:00 PM (prev day) |
| 01:00 | 8:00 PM (prev day) | 5:00 PM (prev day) |
| 02:00 | 9:00 PM (prev day) | 6:00 PM (prev day) |
| 03:00 | 10:00 PM (prev day) | 7:00 PM (prev day) |
| 04:00 | 11:00 PM (prev day) | 8:00 PM (prev day) |
| 05:00 | 12:00 AM | 9:00 PM (prev day) |
| 06:00 | 1:00 AM | 10:00 PM (prev day) |
| 07:00 | 2:00 AM | 11:00 PM (prev day) |
| 08:00 | 3:00 AM | 12:00 AM |
| 09:00 | 4:00 AM | 1:00 AM |
| 10:00 | 5:00 AM | 2:00 AM |
| 11:00 | 6:00 AM | 3:00 AM |
| 12:00 | 7:00 AM | 4:00 AM |
| 13:00 | 8:00 AM | 5:00 AM |
| 14:00 | 9:00 AM | 6:00 AM |
| 15:00 | 10:00 AM | 7:00 AM |
| 16:00 | 11:00 AM | 8:00 AM |
| 17:00 | 12:00 PM | 9:00 AM |
| 18:00 | 1:00 PM | 10:00 AM |
| 19:00 | 2:00 PM | 11:00 AM |
| 20:00 | 3:00 PM | 12:00 PM |
| 21:00 | 4:00 PM | 1:00 PM |
| 22:00 | 5:00 PM | 2:00 PM |
...
| UTC | EDT (UTC−4) | PDT (UTC−7) |
|---|---|---|
| 00:00 | 8:00 PM (prev day) | 5:00 PM (prev day) |
| 01:00 | 9:00 PM (prev day) | 6:00 PM (prev day) |
| 02:00 | 10:00 PM (prev day) | 7:00 PM (prev day) |
| 03:00 | 11:00 PM (prev day) | 8:00 PM (prev day) |
| 04:00 | 12:00 AM | 9:00 PM (prev day) |
| 05:00 | 1:00 AM | 10:00 PM (prev day) |
| 06:00 | 2:00 AM | 11:00 PM (prev day) |
| 07:00 | 3:00 AM | 12:00 AM |
| 08:00 | 4:00 AM | 1:00 AM |
| 09:00 | 5:00 AM | 2:00 AM |
| 10:00 | 6:00 AM | 3:00 AM |
| 11:00 | 7:00 AM | 4:00 AM |
| 12:00 | 8:00 AM | 5:00 AM |
| 13:00 | 9:00 AM | 6:00 AM |
| 14:00 | 10:00 AM | 7:00 AM |
| 15:00 | 11:00 AM | 8:00 AM |
| 16:00 | 12:00 PM | 9:00 AM |
| 17:00 | 1:00 PM | 10:00 AM |
| 18:00 | 2:00 PM | 11:00 AM |
| 19:00 | 3:00 PM | 12:00 PM |
| 20:00 | 4:00 PM | 1:00 PM |
| 21:00 | 5:00 PM | 2:00 PM |
| 22:00 | 6:00 PM | 3:00 PM |
| 23:00 | 7:00 PM | 4:00 PM |
...
- **DST begins:** Sunday, March 8, 2026, at 2:00 AM local time. Clocks move to 3:00 AM.
- **DST ends:** Sunday, November 1, 2026, at 2:00 AM local time. Clocks move back to 1:00 AM.

Before March 8: use the Standard Time table (EST/PST).
From March 8 onward: use the Daylight Saving Time table (EDT/PDT).
From November 1 onward: switch back to the Standard Time table.
...
- **Spring gap:** The US springs forward on March 8. The EU springs forward on March 29. Between those dates, the offset between UTC and US time zones is already shifted, but the offset between the US and Europe is temporarily one hour different from normal.
- **Autumn gap:** The EU falls back on October 25. The US falls back on November 1. Again, a one-week window where the usual difference between US and European clocks is off by one hour.
...
- Use UTC as the anchor for recurring meetings and let each participant's calendar convert to local time.
- Confirm times explicitly during transition weeks.
- Use a tool like [a dedicated time zone converter](/blog/time-zone-converter-for-meetings) to verify before sending invites.
...
Go to Settings > General > Time zone and confirm it matches your physical location. If it is wrong, every event on your calendar will display the wrong local time. See [what Google Calendar's time zone setting actually controls](/blog/google-calendar-time-zone-what-it-controls) for a deeper explanation.
...
If you work across many time zones and want a faster way to see times at a glance, [TimeHopper](https://chromewebstore.google.com/detail/timehopper-calendar-clock/jckljcbopecepadagmnjbfjgojpnfkhl) adds a multi-timezone clock directly to your Google Calendar sidebar.
...
- [NIST: Official US Time](https://www.nist.gov/pml/time-and-frequency-division/time-services/oficial-us-time) — US government atomic clock reference for UTC
- [timeanddate.com: DST Dates 2026](https://www.timeanddate.com/time/change/usa) — Daylight saving time transition dates by country and year
- [IANA Time Zone Database](https://www.iana.org/time-zones) — The authoritative source for global time zone rules used by operating systems and applications
- [Google Calendar Help: Change Time Zone](https://support.google.com/calendar/answer/37064) — Google's documentation on time zone settings in Calendar
- [US Department of Transportation: Daylight Saving Time](https://www.transportation.dot.gov/regulations/daylight-saving-time) — Federal rules governing DST observance in the United States
